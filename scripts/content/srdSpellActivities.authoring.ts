// Build-time compatibility compiler. The application loads declarative JSON instead.
import { SYMBOL_MODES, SYMBOL_LABELS } from '../../src/rulesets/dnd5e/symbolSpell'
import { telekinesisCreatureActivity } from '../../src/rulesets/dnd5e/activities/telekinesisActivity'
import { automationCapabilityFromLegacyStatus } from '../../src/domain/automation/automationCapability'
import type { RegisteredContentDefinition } from '../../src/domain/content/contentDefinitionRegistry'
import type { Dnd5ePluginSpellDefinition } from '../../src/rulesets/dnd5e/pluginApi'
import type { RegisteredDnd5ePluginSpell } from '../../src/rulesets/dnd5e/plugins/pluginRegistryContracts'
import { DND5E_SRD_SPELL_CATALOG } from '../../src/rulesets/dnd5e/spellCatalog'
import { DND5E_SRD_SPELL_DESCRIPTIONS_ZH_REVIEWED } from '../../src/rulesets/dnd5e/spellDescriptionsZh.reviewed.generated'
import type { Dnd5eImportedSpell } from '../../src/rulesets/dnd5e/spellbook'
import {
  DND5E_SRD_AUDITED_SPELL_DECISIONS_V1,
} from '../../src/rulesets/dnd5e/activities/dnd5eSrdAuditedSpellDecisions'
export {
  dnd5eSrdAuditedSpellDecisionV1,
  type Dnd5eSrdAuditedSpellTargetV1,
} from '../../src/rulesets/dnd5e/activities/dnd5eSrdAuditedSpellDecisions'
import { dnd5eActivityFromSpellDefinition } from '../../src/rulesets/dnd5e/activities/legacyContentActivityAdapters'
import type {
  Dnd5eActivityChoiceOptionV1,
  Dnd5eActivityDefinitionV1,
  Dnd5eActivityOperationV1,
} from '../../src/rulesets/dnd5e/activities/dnd5eActivityContracts'
import type { Dnd5eEffectDefinitionV1 } from '../../src/rulesets/dnd5e/activities/dnd5eEffectContracts'
import type { AbilityKey } from '../../src/lib/dnd'
import { DND5E_DAMAGE_TYPES } from '../../src/rulesets/dnd5e/damageTypes'
import { DND5E_SRD_MONSTERS } from '../../src/rulesets/dnd5e/monsters'
import { dnd5eChallengeRatingValue } from '../../src/rulesets/dnd5e/wildShape'
import { dnd5eCoreSpellMaterialRequirement } from '../../src/rulesets/dnd5e/spellMaterials'
