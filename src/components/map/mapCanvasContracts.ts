...
export interface AoeHighlight {
  iceWallPreview?: boolean
  forceWallPreview?: boolean
  stoneWallPanels?: import('../../rulesets/dnd5e/stoneWall').StoneWallPanel[]
  stoneWallDraftPanelId?: string
  cells: GridCell[]
