              ...
              <div className="mt-3 space-y-2">
                {draft.headlessMechanics.map((mechanic, index) => {
                  ...
                  const compatibilityReasons = [
                    ...
                    ...(['damage', 'standard-condition', 'remove-standard-condition'].includes(mechanic.effectKind) && mechanic.effectTarget === 'trigger-target' && mechanic.trigger !== 'after-hit' ? ['触发目标当前只在命中后事务中可用'] : []),
                    ...(['damage', 'standard-condition', 'remove-standard-condition'].includes(mechanic.effectKind) && mechanic.effectTarget === 'damage-source' ? ['伤害来源目标依赖受到伤害后的反应事务'] : []),
