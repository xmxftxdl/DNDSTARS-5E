...
规则 ID：`srd-5.1:swarm-of-poisonous-snakes`。结论：**本次已覆盖范围通过**。
...
> 毒蛇群 使用群体啃咬攻击 验证目标：群体啃咬 → 验证目标 19+6=25 命中；共造成 16 点伤害。
...
- [本怪物字段与结果证据](../evidence/swarm-of-poisonous-snakes.json)
- [总索引与运行说明](../README.md)
