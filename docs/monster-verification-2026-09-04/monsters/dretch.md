...
规则 ID：`srd-5.1:dretch`。结论：**本次已覆盖范围通过**。
...
> 怯魔 使用啃咬攻击 验证目标：啃咬 → 验证目标 1+2=3 未命中；共造成 0 点伤害。
...
| 动作 | 恶臭云雾 / `fetid-cloud` | headless | persistent-area | 通过 | minimum、maximum、no-resource |
...
- [本怪物字段与结果证据](../evidence/dretch.json)
- [总索引与运行说明](../README.md)
