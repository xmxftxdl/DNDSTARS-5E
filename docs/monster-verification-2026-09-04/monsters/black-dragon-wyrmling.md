...
规则 ID：`srd-5.1:black-dragon-wyrmling`。结论：**本次已覆盖范围通过**。
...
> 黑龙雏龙 使用啃咬攻击 验证目标：啃咬 → 验证目标 18+4=22 命中；共造成 8 点伤害。
...
| 动作 | 强酸吐息 / `acid-breath` | headless | area-saving-throw | 通过 | failed-save、successful-save、duplicate-target、exhausted-resource |
...
- [本怪物字段与结果证据](../evidence/black-dragon-wyrmling.json)
- [总索引与运行说明](../README.md)
