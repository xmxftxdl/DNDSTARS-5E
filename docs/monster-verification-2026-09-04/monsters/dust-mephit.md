...
规则 ID：`srd-5.1:dust-mephit`。结论：**本次已覆盖范围通过**。
...
> 尘土魔蝠 使用双爪攻击 验证目标：双爪 → 验证目标 16+4=20 命中；共造成 6 点伤害。
...
| 动作 | 致盲吐息 / `blinding-breath` | headless | area-saving-throw | 通过 | failed-save、successful-save、duplicate-target、exhausted-resource |
...
- [本怪物字段与结果证据](../evidence/dust-mephit.json)
- [总索引与运行说明](../README.md)
