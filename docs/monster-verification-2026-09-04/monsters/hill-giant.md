...
规则 ID：`srd-5.1:hill-giant`。结论：**本次已覆盖范围通过**。
...
通过：巨棒。已验证真实 DM 控制台点击、选择目标、动作消耗、玩家日志同步及玩家先攻栏 HP。HP 320 → 296/320。

> 丘陵巨人 使用巨棒攻击 验证目标：巨棒 → 验证目标 19+8=27 命中；共造成 24 点伤害。
...
- [本怪物字段与结果证据](../evidence/hill-giant.json)
- [总索引与运行说明](../README.md)
