...
规则 ID：`srd-5.1:glabrezu`。结论：**本次已覆盖范围通过**。
...
通过：螯击。已验证真实 DM 控制台点击、选择目标、动作消耗、玩家日志同步及玩家先攻栏 HP。HP 320 → 304/320。

> 格拉兹特魔 使用螯击攻击 验证目标：螯击 → 验证目标 3+9=12 命中；共造成 16 点伤害。
...
- [本怪物字段与结果证据](../evidence/glabrezu.json)
- [总索引与运行说明](../README.md)
