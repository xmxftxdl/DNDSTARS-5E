# 虎人（虎形态）（Weretiger, Tiger Form）

规则 ID：`srd-5.1:weretiger-tiger`。结论：**本次已覆盖范围通过**。
...
> 虎人（虎形态） 使用啃咬攻击 验证目标：啃咬 → 验证目标 5+5=10 命中；共造成 6 点伤害。
...
- [本怪物字段与结果证据](../evidence/weretiger-tiger.json)
- [总索引与运行说明](../README.md)
