...
规则 ID：`srd-5.1:hydra`。结论：**本次已覆盖范围通过**。
...
> 多头蛇 使用啃咬攻击 验证目标：啃咬 → 验证目标 12+8=20 命中；共造成 8 点伤害。
...
| 多头 | dm-adjudication | 无结构化处理器 | DM 裁定 / 情境判断 | — |
| 多头反应 | dm-adjudication | 无结构化处理器 | DM 裁定 / 情境判断 | — |
...
- [本怪物字段与结果证据](../evidence/hydra.json)
- [总索引与运行说明](../README.md)
