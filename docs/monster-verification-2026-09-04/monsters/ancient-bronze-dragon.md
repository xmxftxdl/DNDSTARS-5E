...
规则 ID：`srd-5.1:ancient-bronze-dragon`。结论：**Headless 已验证，仍有 DM 裁定边界**。
...
> 远古青铜龙 使用啃咬攻击 验证目标：啃咬 → 验证目标 10+16=26 命中；共造成 25 点伤害。
...
- [本怪物字段与结果证据](../evidence/ancient-bronze-dragon.json)
- [总索引与运行说明](../README.md)
