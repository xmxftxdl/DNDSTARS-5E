...
规则 ID：`srd-5.1:fire-giant`。结论：**本次已覆盖范围通过**。
...
通过：巨剑。已验证真实 DM 控制台点击、选择目标、动作消耗、玩家日志同步及玩家先攻栏 HP。HP 320 → 293/320。

> 火巨人 使用巨剑攻击 验证目标：巨剑 → 验证目标 15+11=26 命中；共造成 27 点伤害。
...
- [本怪物字段与结果证据](../evidence/fire-giant.json)
- [总索引与运行说明](../README.md)
