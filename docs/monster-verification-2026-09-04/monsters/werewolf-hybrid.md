# 狼人（混合形态）（Werewolf, Hybrid Form）

规则 ID：`srd-5.1:werewolf-hybrid`。结论：**本次已覆盖范围通过**。
...
> 狼人（混合形态） 使用啃咬攻击 验证目标：啃咬 → 验证目标 4+4=8 未命中；共造成 0 点伤害。
...
- [本怪物字段与结果证据](../evidence/werewolf-hybrid.json)
- [总索引与运行说明](../README.md)
