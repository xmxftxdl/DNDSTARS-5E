...
规则 ID：`srd-5.1:giant-elk`。结论：**本次已覆盖范围通过**。
...
通过：冲撞。已验证真实 DM 控制台点击、选择目标、动作消耗、玩家日志同步及玩家先攻栏 HP。HP 320 → 311/320。

> 巨鹿 使用冲撞攻击 验证目标：冲撞 → 验证目标 19+6=25 命中；共造成 9 点伤害。
...
- [本怪物字段与结果证据](../evidence/giant-elk.json)
- [总索引与运行说明](../README.md)
