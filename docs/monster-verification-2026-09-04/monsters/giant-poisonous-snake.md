# 巨型毒蛇（Giant Poisonous Snake）

规则 ID：`srd-5.1:giant-poisonous-snake`。结论：**本次已覆盖范围通过**。
...
> 巨型毒蛇 使用啃咬攻击 验证目标：啃咬 → 验证目标 13+6=19 命中；共造成 10 点伤害。
...
- [本怪物字段与结果证据](../evidence/giant-poisonous-snake.json)
- [总索引与运行说明](../README.md)
