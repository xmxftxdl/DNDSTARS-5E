...
规则 ID：`srd-5.1:ancient-gold-dragon`。结论：**Headless 已验证，仍有 DM 裁定边界**。
...
> 远古金龙 使用啃咬攻击 验证目标：啃咬 → 验证目标 2+17=19 命中；共造成 26 点伤害。
...
- [本怪物字段与结果证据](../evidence/ancient-gold-dragon.json)
- [总索引与运行说明](../README.md)
