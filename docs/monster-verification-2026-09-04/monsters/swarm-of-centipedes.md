# 蜈蚣群（Swarm of Centipedes）

规则 ID：`srd-5.1:swarm-of-centipedes`。结论：**本次已覆盖范围通过**。
...
> 蜈蚣群 使用群体啃咬攻击 验证目标：群体啃咬 → 验证目标 4+3=7 未命中；共造成 0 点伤害。
...
- [本怪物字段与结果证据](../evidence/swarm-of-centipedes.json)
- [总索引与运行说明](../README.md)
