...
规则 ID：`srd-5.1:ape`。结论：**本次已覆盖范围通过**。
...
通过：拳击。已验证真实 DM 控制台点击、选择目标、动作消耗、玩家日志同步及玩家先攻栏 HP。HP 320 → 316/320。

> 猿 使用拳击攻击 验证目标：拳击 → 验证目标 11+5=16 命中；共造成 4 点伤害。
