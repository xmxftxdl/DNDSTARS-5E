...
规则 ID：`srd-5.1:bone-devil`。结论：**本次已覆盖范围通过**。
...
> 骨魔 使用爪击攻击 验证目标：爪击 → 验证目标 6+8=14 命中；共造成 6 点伤害。
...
| 动作 | 螫刺 / `sting` | headless | weapon-attack | 通过 | miss、hit、critical、sting-poisoned:apply、sting-poisoned:save、sting-poisoned:condition-immune |
...
- [本怪物字段与结果证据](../evidence/bone-devil.json)
- [总索引与运行说明](../README.md)
