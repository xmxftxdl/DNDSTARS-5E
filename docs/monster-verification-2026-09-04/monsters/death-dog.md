...
规则 ID：`srd-5.1:death-dog`。结论：**本次已覆盖范围通过**。
...
> 死亡犬 使用啃咬攻击 验证目标：啃咬 → 验证目标 9+4=13 命中；共造成 4 点伤害。
...
| --- | --- | --- | --- | --- |
| 双头生物 | dm-adjudication | 无结构化处理器 | DM 裁定 / 情境判断 | — |

特性列表表示目录现状；除上面明确列出的定向回归外，不以本次武器攻击代替回合开始、受击、死亡、重生等特性的独立触发验证。

## 复查材料

- [本怪物字段与结果证据](../evidence/death-dog.json)
- [总索引与运行说明](../README.md)
