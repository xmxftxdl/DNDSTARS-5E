...
规则 ID：`srd-5.1:vampire-spawn`。结论：**本次已覆盖范围通过**。
...
通过：双爪。已验证真实 DM 控制台点击、选择目标、动作消耗、玩家日志同步及玩家先攻栏 HP。HP 320 → 315/320。

> 吸血鬼衍体 使用双爪攻击 验证目标：双爪 → 验证目标 13+6=19 命中；共造成 5 点伤害。
...
| 动作 | 双爪 / `claws` | headless | weapon-attack | 通过 | miss、hit、critical |
| 动作 | 双爪 (Grapple) / `claws-grapple` | headless | weapon-attack | 通过 | miss、hit、critical |
| 动作 | 多重攻击：双爪 ×2 / `multiattack-claws-and-bite` | headless | multiattack | 通过 | complete-sequence |
| 动作 | 多重攻击：双爪 ×2 / `multiattack-claws-and-grapple` | headless | multiattack | 通过 | complete-sequence |
| 动作 | 多重攻击：claws-grapple ×2 / `multiattack-grapple-and-claws` | headless | multiattack | 通过 | complete-sequence |
| 动作 | 多重攻击：claws-grapple ×2 / `multiattack-grapples` | headless | multiattack | 通过 | complete-sequence |
| 动作 | 多重攻击：claws-grapple ×2 / `multiattack-grapple-and-bite` | headless | multiattack | 通过 | complete-sequence |
...
- [本怪物字段与结果证据](../evidence/vampire-spawn.json)
- [总索引与运行说明](../README.md)
