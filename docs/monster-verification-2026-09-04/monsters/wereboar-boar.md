# 野猪人（野猪形态）（Wereboar, Boar Form）

规则 ID：`srd-5.1:wereboar-boar`。结论：**本次已覆盖范围通过**。
...
通过：双獠牙。已验证真实 DM 控制台点击、选择目标、动作消耗、玩家日志同步及玩家先攻栏 HP。HP 320 → 320/320。

> 野猪人（野猪形态） 使用双獠牙攻击 验证目标：双獠牙 → 验证目标 1+5=6 未命中；共造成 0 点伤害。
...
- [本怪物字段与结果证据](../evidence/wereboar-boar.json)
- [总索引与运行说明](../README.md)
