# 染病巨鼠（Giant Rat (Diseased)）

规则 ID：`srd-5.1:giant-rat-diseased`。结论：**本次已覆盖范围通过**。
...
> 染病巨鼠 使用啃咬攻击 验证目标：啃咬 → 验证目标 10+4=14 命中；共造成 4 点伤害。
...
| --- | --- | --- | --- | --- | --- |
| 动作 | 啃咬 / `bite` | headless | weapon-attack | 通过 | miss、hit、critical、diseased-bite:apply、diseased-bite:save、calendar-boundary-replay-and-cure |
...
- [本怪物字段与结果证据](../evidence/giant-rat-diseased.json)
- [总索引与运行说明](../README.md)
