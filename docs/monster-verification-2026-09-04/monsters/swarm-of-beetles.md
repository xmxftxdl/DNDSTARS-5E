# 甲虫群（Swarm of Beetles）

规则 ID：`srd-5.1:swarm-of-beetles`。结论：**本次已覆盖范围通过**。
...
> 甲虫群 使用群体啃咬攻击 验证目标：群体啃咬 → 验证目标 12+3=15 命中；共造成 12 点伤害。
...
- [本怪物字段与结果证据](../evidence/swarm-of-beetles.json)
- [总索引与运行说明](../README.md)
