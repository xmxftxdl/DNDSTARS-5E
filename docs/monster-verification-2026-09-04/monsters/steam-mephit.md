...
规则 ID：`srd-5.1:steam-mephit`。结论：**本次已覆盖范围通过**。
...
> 蒸汽魔蝠 使用双爪攻击 验证目标：双爪 → 验证目标 11+2=13 命中；共造成 6 点伤害。
...
| 动作 | 蒸汽吐息 / `steam-breath` | headless | area-saving-throw | 通过 | failed-save、successful-save、duplicate-target、exhausted-resource |
...
- [本怪物字段与结果证据](../evidence/steam-mephit.json)
- [总索引与运行说明](../README.md)
