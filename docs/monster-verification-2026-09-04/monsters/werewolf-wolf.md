# 狼人（狼形态）（Werewolf, Wolf Form）

规则 ID：`srd-5.1:werewolf-wolf`。结论：**本次已覆盖范围通过**。
...
> 狼人（狼形态） 使用啃咬攻击 验证目标：啃咬 → 验证目标 15+4=19 命中；共造成 10 点伤害。
...
- [本怪物字段与结果证据](../evidence/werewolf-wolf.json)
- [总索引与运行说明](../README.md)
