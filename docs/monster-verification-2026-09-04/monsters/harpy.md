...
规则 ID：`srd-5.1:harpy`。结论：**Headless 已验证，仍有 DM 裁定边界**。
...
> 鹰身女妖 使用双爪攻击 验证目标：双爪 → 验证目标 2+3=5 未命中；共造成 0 点伤害。
...
| 动作 | 诱惑之歌 / `luring-song` | dm-adjudication | other | DM 裁定 / 非战斗 | — |
...
- [本怪物字段与结果证据](../evidence/harpy.json)
- [总索引与运行说明](../README.md)
