...
规则 ID：`srd-5.1:cloud-giant`。结论：**本次已覆盖范围通过**。
...
通过：晨星锤。已验证真实 DM 控制台点击、选择目标、动作消耗、玩家日志同步及玩家先攻栏 HP。HP 320 → 303/320。

> 云巨人 使用晨星锤攻击 验证目标：晨星锤 → 验证目标 4+12=16 命中；共造成 17 点伤害。
...
- [本怪物字段与结果证据](../evidence/cloud-giant.json)
- [总索引与运行说明](../README.md)
